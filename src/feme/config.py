...
class Settings:
    ...
    postgres_dsn: str = os.getenv("FEME_POSTGRES_DSN", os.getenv("DATABASE_URL", ""))
    ...
    extractor_schema_version: str = os.getenv(
        "FEME_EXTRACTOR_SCHEMA_VERSION", "claim-extraction-v1"
    )
    require_extractor_audit: bool = _as_bool(
        os.getenv("FEME_REQUIRE_EXTRACTOR_AUDIT"), False
    )
    ...
    api_key_admin: str = os.getenv("FEME_API_KEY_ADMIN", os.getenv("FEME_API_KEY", ""))
